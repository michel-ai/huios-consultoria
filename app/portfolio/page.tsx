  ...
  const otherProjects = [
    {
      ...
      category: "varejo",
      client: "Provedor de Internet",
      description: "Rede Wi-Fi de alta capacidade para 2.000+ usuários simultâneos com portal captivo personalizado",
      technologies: ["Ubiquiti", "RADIUS", "Captive Portal", "Load Balancing"],
      image: "🛍️",
      color: "#2ed573",
      metrics: { duration: "3 meses",},
    },
    {
      id: 5,
  ...
  const testimonials = [
    {
      ...
      avatar: "AS",
      rating: 5,
      text: "A nova rede corporativa aumentou nossa produtividade em 45%. A equipe da Huios é altamente qualificada e entregou o projeto no prazo estabelecido.",
